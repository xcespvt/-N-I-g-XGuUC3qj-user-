...
import { ArrowLeft, Headset, MapPin, Calendar, Clock, Users, Utensils, AppWindow, Store, Gamepad2, Clapperboard, Music, Tv, Gamepad, Headphones, Phone, Map } from 'lucide-react';
...
function TrackBookingPageComponent() {
    ...
    <div className="flex h-screen w-full flex-col bg-gray-50">
      <header className="sticky top-0 z-10 flex h-16 shrink-0 items-center justify-between border-b bg-white px-4">
        <div className="flex items-center gap-2">
            ...
            <div>
                ...
                <p className="text-xs text-muted-foreground">Table Booking</p>
            </div>
        </div>
      ...
      <main className="flex-1 overflow-y-auto p-4 space-y-4">
        <div className="rounded-2xl bg-white p-4 shadow-sm text-center">
            ...
            <p className="text-muted-foreground text-sm mt-1">We're waiting for you.</p>
